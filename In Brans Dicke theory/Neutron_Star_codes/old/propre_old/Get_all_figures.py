...
#
        ...
        relative_gamma_vec = np.append(relative_gamma_vec, (gamma_edd - gamma_BD)/gamma_BD )
#
...
#
    ...
    fig.legend( bbox_to_anchor=(0.9, 0.6))
    plt.savefig(f'./evaluating_gamma_relative_with_alpha.png', dpi = 200,bbox_inches='tight')
    # plt.show()
    plt.close()
...
make_gamma_beta_plots(50,1, w=1)
