...
def plot_w_vs_rho(lowest_w, highest_w, n, count):
    ...
    if count==0:
        ...
        mesh = plt.pcolormesh(den_space, w_values, gamma_edd_all, shading='auto', cmap='gray')
        ...
        plt.figure(figsize=(8,6))
        mesh = plt.pcolormesh(den_space, w_values, 1-gamma_edd_all, shading='auto', cmap='gray')
        cbar = plt.colorbar(mesh)
        ...
        plt.figure(figsize=(8,6))
        mesh = plt.pcolormesh(den_space, w_values, gamma_deviation_all, shading='auto', cmap='gray')
        cbar = plt.colorbar(mesh)
        ...
        plt.figure(figsize=(8,6))
        mesh = plt.pcolormesh(den_space, w_values, gamma_BD_all, shading='auto', cmap='gray')
        cbar = plt.colorbar(mesh)
        cbar.set_label(r'$\gamma$')
        # cbar.ax.set_yscale("log")
        plt.yscale("log")
